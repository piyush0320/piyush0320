<img src="https://github.com/piyush0320/image/blob/main/img2.png" alt="DevOps & Cloud Engineer Banner" width="100%" />
...
### 👨‍💻 About Me
- **Name:** PIYUSH PATIL
- 🏢 **Experience:** DevOps & AWS Cloud
- 🎓 **Certifications:**
  - ✅ AWS - Solutions Architecture Job Simulation Forage 🏆
  - ✅ IBM SkillsBuild Digital Badge in Cloud Computing Fundamental 🏆
- 🌍 **Skills & Expertise:**
  - Cloud Computing (AWS)
  ...
  - Monitoring, Logging, and Security (Prometheus, DataDog, AWS Security Services)
...
## 📌 Featured Projects
- 🔹 **Jenkins Agent Setup for CI/CD on AWS** - Implemented Jenkins, AWS EC2, Linux, Git, GitHub, SSH, CI/CD, Bash.
- 🔹 **Low-Latency Live Streaming System** - Set up AWS EC2, NGINX, RTMP, HLS, OBS Studio, hls.js, Linux, HTTP, Streaming Protocols.
...
<!--
**piyush0320/piyush0320** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
